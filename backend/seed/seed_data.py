...
def seed():
    ...
    snakes = [
        # Non-Venomous
        {
            ...
            "interesting_facts": ["One of India's fastest snakes.", "Often relies on speed rather than camouflage for survival.", "Can rapidly flee across open ground."],
            "ecological_role": "Controls populations of rodents, lizards, and frogs.",
            "human_risk_level": "Very Low",
            "peak_activity": "7 AM - 5 PM",
            "lifespan_years": {"wild": 10, "captivity": 15},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "4-12 eggs", "breeding_season": "March-June"},
            "natural_predators": ["Eagles", "Kites", "Mongooses"],
            "conservation_threats": ["Road mortality", "Habitat degradation"],
            "myths_and_facts": [{"myth": "It is a type of cobra.", "fact": "It is a completely harmless non-venomous snake."}],
            "benefits_to_humans": ["Helps control agricultural pests."],
            "did_you_know": "The Banded Racer can move faster than many other Indian snake species.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["One of India's most common water snakes.", "Excellent swimmer and diver.", "Can remain underwater for several minutes."],
            "ecological_role": "Maintains healthy fish and amphibian populations.",
            "human_risk_level": "Very Low",
            "peak_activity": "6 AM - 5 PM",
            "lifespan_years": {"wild": 8, "captivity": 12},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "6-30 eggs", "breeding_season": "June-August"},
            "natural_predators": ["Herons", "Eagles", "Monitor lizards"],
            "conservation_threats": ["Wetland destruction", "Water pollution"],
            "myths_and_facts": [{"myth": "All water snakes are venomous.", "fact": "Most Indian water snakes are harmless."}],
            "benefits_to_humans": ["Maintains balance in freshwater ecosystems."],
            "did_you_know": "Checkered Keelbacks are often seen hunting fish in village ponds.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["One of the longest snakes found in India.", "Can climb trees and swim efficiently.", "Frequently mistaken for a cobra."],
            "ecological_role": "Major controller of rat populations in agricultural areas.",
            "human_risk_level": "Low",
            "peak_activity": "7 AM - 5 PM",
            "lifespan_years": {"wild": 12, "captivity": 20},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "6-20 eggs", "breeding_season": "March-July"},
            "natural_predators": ["Mongooses", "Eagles", "Large monitor lizards"],
            "conservation_threats": ["Roadkills", "Persecution due to misidentification"],
            "myths_and_facts": [{"myth": "Rat snakes are baby cobras.", "fact": "Rat snakes and cobras are completely different species."}],
            "benefits_to_humans": ["Reduces rodent damage to crops."],
            "did_you_know": "A rat snake can consume dozens of crop-damaging rodents annually.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["Known as the 'two-headed snake' because of its blunt tail.", "Spends much of its life underground.", "Among the most illegally trafficked snakes in India."],
            "ecological_role": "Controls rodents and small reptiles.",
            "human_risk_level": "Very Low",
            "peak_activity": "7 PM - 4 AM",
            "lifespan_years": {"wild": 15, "captivity": 20},
            "reproduction": {"type": "Viviparous", "offspring_per_clutch": "4-15 young", "breeding_season": "April-July"},
            "natural_predators": ["Birds of prey", "Mongooses"],
            "conservation_threats": ["Illegal wildlife trade", "Roadkills"],
            "myths_and_facts": [{"myth": "It has two heads.", "fact": "Its tail only resembles a second head."}],
            "benefits_to_humans": ["Naturally reduces rodent populations."],
            "did_you_know": "Sand Boas are frequently targeted by wildlife traffickers because of superstitions.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["Popular among reptile enthusiasts because of its striking appearance.", "An efficient constrictor.", "Known for its defensive attitude."],
            "ecological_role": "Controls rodents and small vertebrates.",
            "human_risk_level": "Low",
            "peak_activity": "7 AM - 5 PM",
            "lifespan_years": {"wild": 12, "captivity": 18},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "5-15 eggs", "breeding_season": "April-June"},
            "natural_predators": ["Raptors", "Mongooses"],
            "conservation_threats": ["Habitat loss"],
            "myths_and_facts": [{"myth": "Aggressive snakes are always venomous.", "fact": "Many harmless snakes behave defensively."}],
            "benefits_to_humans": ["Reduces agricultural pests."],
            "did_you_know": "The Common Trinket often scares predators through bluffing rather than fighting.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["Has binocular vision.", "Excellent camouflage.", "Often mistaken for a venomous species."],
            "ecological_role": "Controls lizards and frogs in trees.",
            "human_risk_level": "Very Low",
            "peak_activity": "7 AM - 4 PM",
            "lifespan_years": {"wild": 10, "captivity": 15},
            "reproduction": {"type": "Viviparous", "offspring_per_clutch": "5-15 young", "breeding_season": "May-August"},
            "natural_predators": ["Birds of prey", "Tree-dwelling mammals"],
            "conservation_threats": ["Deforestation", "Urban expansion"],
            "myths_and_facts": [{"myth": "It can blind people by pecking eyes.", "fact": "This is a myth with no scientific basis."}],
            "benefits_to_humans": ["Controls frogs and lizards naturally."],
            "did_you_know": "Its pupils are uniquely keyhole-shaped.",
        ...
        },
        {
            ...
            "interesting_facts": ["One of India's largest snakes.", "Kills prey by constriction.", "Excellent swimmer."],
            "ecological_role": "Controls populations of mammals and birds.",
            "human_risk_level": "Moderate",
            "peak_activity": "6 PM - 5 AM",
            "lifespan_years": {"wild": 20, "captivity": 30},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "20-100 eggs", "breeding_season": "December-March"},
            "natural_predators": ["Large crocodiles", "Leopards", "Humans"],
            "conservation_threats": ["Habitat fragmentation", "Poaching", "Road mortality"],
            "myths_and_facts": [{"myth": "Pythons crush bones before swallowing prey.", "fact": "They kill prey through constriction and suffocation."}],
            "benefits_to_humans": ["Controls populations of crop-damaging mammals."],
            "did_you_know": "Female pythons can generate heat by shivering to incubate eggs.",
        ...
        # Venomous
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["Among the most venomous snakes in India.", "Bites are often painless.", "Highly active at night."],
            "ecological_role": "Controls rodents and other snakes.",
            "human_risk_level": "Extreme",
            "peak_activity": "8 PM - 4 AM",
            "lifespan_years": {"wild": 10, "captivity": 15},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "8-20 eggs", "breeding_season": "March-May"},
            "natural_predators": ["Mongooses", "Birds of prey"],
            "conservation_threats": ["Habitat destruction", "Road mortality"],
            "myths_and_facts": [{"myth": "A painless bite means no danger.", "fact": "Krait bites may be painless but can be fatal."}],
            "benefits_to_humans": ["Controls rodent populations around settlements."],
            "did_you_know": "Many krait bites occur when people sleep on floors at night.",
        ...
        },
        {
            ...
            "interesting_facts": ["World's longest venomous snake.", "Feeds mainly on other snakes.", "Only snake known to build a nest."],
            "ecological_role": "Top predator that regulates snake populations.",
            "human_risk_level": "Extreme",
            "peak_activity": "8 AM - 3 PM",
            "lifespan_years": {"wild": 20, "captivity": 25},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "20-40 eggs", "breeding_season": "January-April"},
            "natural_predators": ["Humans", "Large raptors"],
            "conservation_threats": ["Deforestation", "Habitat fragmentation", "Illegal killing"],
            "myths_and_facts": [{"myth": "King Cobras are true cobras.", "fact": "King Cobras belong to a separate genus from true cobras."}],
            "benefits_to_humans": ["Helps regulate populations of venomous snakes."],
            "did_you_know": "A king cobra can raise over a meter of its body off the ground.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["Named after the circular mark on its hood.", "Widely distributed across eastern India.", "Highly adaptable to agricultural landscapes."],
            "ecological_role": "Controls rodents and amphibians.",
            "human_risk_level": "Extreme",
            "peak_activity": "5 PM - 11 PM",
            "lifespan_years": {"wild": 15, "captivity": 20},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "15-30 eggs", "breeding_season": "April-July"},
            "natural_predators": ["Mongooses", "Large birds of prey"],
            "conservation_threats": ["Habitat loss", "Human persecution"],
            "myths_and_facts": [{"myth": "Cobras chase people.", "fact": "Cobras usually prefer escape over confrontation."}],
            "benefits_to_humans": ["Controls rodent populations."],
            "did_you_know": "The monocle marking varies greatly among individuals.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["Responsible for a large number of snakebite cases in India.", "Produces a loud warning hiss.", "Can strike with remarkable speed."],
            "ecological_role": "Controls rodent populations.",
            "human_risk_level": "Extreme",
            "peak_activity": "7 PM - 3 AM",
            "lifespan_years": {"wild": 12, "captivity": 18},
            "reproduction": {"type": "Viviparous", "offspring_per_clutch": "20-60 young", "breeding_season": "June-September"},
            "natural_predators": ["Mongooses", "Birds of prey"],
            "conservation_threats": ["Roadkills", "Habitat loss"],
            "myths_and_facts": [{"myth": "Large vipers always attack humans.", "fact": "Most bites occur when the snake is disturbed or stepped on."}],
            "benefits_to_humans": ["Controls crop-damaging rodents."],
            "did_you_know": "Russell's Viper gives birth to live young instead of laying eggs.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["One of the smallest yet most dangerous snakes in India.", "Produces a sizzling warning sound.", "Thrives in arid environments."],
            "ecological_role": "Controls insects, rodents and small reptiles.",
            "human_risk_level": "Extreme",
            "peak_activity": "8 PM - 2 AM",
            "lifespan_years": {"wild": 8, "captivity": 12},
            "reproduction": {"type": "Viviparous", "offspring_per_clutch": "3-15 young", "breeding_season": "April-August"},
            "natural_predators": ["Mongooses", "Owls", "Eagles"],
            "conservation_threats": ["Road mortality", "Habitat degradation"],
            "myths_and_facts": [{"myth": "Small snakes are less dangerous.", "fact": "Some of the deadliest snakes are relatively small."}],
            "benefits_to_humans": ["Controls rodent and insect populations."],
            "did_you_know": "It creates its famous warning sound by rubbing specialized scales together.",
        ...
        },
        {
            ...
            "iucn_status": "Least Concern",
            "interesting_facts": ["One of India's most recognizable snakes.", "Can raise the front part of its body and spread a hood.", "Featured prominently in Indian folklore."],
            "ecological_role": "Controls rodent and amphibian populations.",
            "human_risk_level": "Extreme",
            "peak_activity": "5 PM - 10 PM",
            "lifespan_years": {"wild": 15, "captivity": 20},
            "reproduction": {"type": "Oviparous", "offspring_per_clutch": "10-30 eggs", "breeding_season": "April-July"},
            "natural_predators": ["Mongooses", "Birds of prey"],
            "conservation_threats": ["Habitat destruction", "Illegal killing"],
            "myths_and_facts": [{"myth": "Cobras drink milk.", "fact": "Snakes cannot properly digest milk."}, {"myth": "Cobras take revenge.", "fact": "Snakes do not remember people and cannot seek revenge."}],
            "benefits_to_humans": ["Controls rodents around farms and villages."],
            "did_you_know": "The spectacle mark is not present in every individual cobra.",
